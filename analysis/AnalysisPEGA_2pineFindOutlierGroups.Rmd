...
### Run a unit test check that outliers add up
### They might not add up perfectly if there is an outlier SNP in a variable not considered in group 2 or group 3, or if one SNP is in both groups
...
head(go$contig2)
head(G1_df$contig)
### Remove seq1, but check in all rows first
