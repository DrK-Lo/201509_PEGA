...
PE$pine_score1_ALL_corrected_bayenv <- PE$pine_score2_ALL_corrected_bayenv <- PE$pine_slope_ALL_corrected_bayenv <- PE$spruce_score1_ALL_corrected_bayenv <- PE$spruce_score2_ALL_corrected_bayenv <- PE$spruce_slope_ALL_corrected_bayenv  <- PE$pine_score1_ALL_raw <- PE$pine_score2_ALL_raw <- PE$pine_slope_ALL_raw <- PE$spruce_score1_ALL_raw <- PE$spruce_score2_ALL_raw <- PE$spruce_slope_ALL_raw <- PE$pine_score1_ALL_corrected_lfmm <- PE$pine_score2_ALL_corrected_lfmm <- PE$pine_slope_ALL_corrected_lfmm <- PE$spruce_score1_ALL_corrected_lfmm <- PE$spruce_score2_ALL_corrected_lfmm <- PE$spruce_slope_ALL_corrected_lfmm <- NA
...
#####################
  ...
  GWAS_effect_cols_pine_bayenv <- grep(gsub("_p","_rho",paste("^",GWAS_pheno_name_raw, sep="")), results_pine_head)
    if (length(GWAS_effect_cols_pine_bayenv)!=2){print("ERROR: GWAS_effect_cols_pine_corrected does not equal 2")}
...
#####################
  ...
  GEA_effect_col_pine_gcta <- grep(paste("^",GEA_envi_name,"_snp_effect_GCTA", sep=""), results_pine_head)
    ...
    GEA_effect_pine_gcta <- results_pine[,GEA_effect_col_pine_gcta]
...
### This plot has the allele coding problem
  ...
  #             xlim = 1, ylim = 1)
png(paste("figure_raw_vs_corrected/both_",
    PE_pheno_name,"_",i, "_", PE_envi_name,".png",sep=""), width=10, height=15, units="in", res=300)
  par(mfcol=c(4,2), mar=c(4,4,4,1), oma=c(0,0,3,3), cex.main=0.8)
...
### Plot PINE GWAS raw vs. corrected
  ...
  GWAS_gcta_pine_GOOD <- GWAS_effect_pine_gcta*results_pine$flip_pine_gwas
...
###################
#png(paste("figure_raw_vs_corrected/spruce_",
#    PE_pheno_name,"_",i, "_", PE_envi_name,".png",sep=""), width=5, height=15, units="in", res=300)
#  par(mfrow=c(4,1), mar=c(4,4,4,1), oma=c(0,0,3,3), cex.main=0.8)
...
#    mtext(paste(i, GEA_envi_name, GWAS_pheno_name))
  ...
  ### raw_GWAS vs gcta
  GWAS_gcta_spruce_GOOD <- GWAS_effect_spruce_gcta*results_spruce$flip_spruce_gwas
...
###############
  ...
  png(paste("figure_byPheno/PEGA_" ,PE_pheno_name,"_",i, "_", PE_envi_name,".png",sep=""), width=10, height=15, units="in", res=300)
