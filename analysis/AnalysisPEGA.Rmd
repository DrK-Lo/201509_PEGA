...
load("../data/large_files/var_out_GATK3_spruce_ALL.summary.ALL.annots.sorted.GOOD.window_RESULTS_altGCTABAYENV_flipped_withSuper.Rdata")
  }
  dim(results_spruce)
...
in_super_spruce <- read.table ("../data/large_files/super_outliers_per_variable_spruce_both_methods_100x.txt",T)
in_super_pine_raw <- read.table ("../data/large_files/super_outliers_per_variable_pine_both_methods_100x_raw.txt",T)
in_super_spruce_raw <- read.table ("../data/large_files/super_outliers_per_variable_spruce_both_methods_100x_raw.txt",T)
good_super_spruce <- in_super_spruce [(in_super_spruce$outlier_count > in_super_spruce$p4),]
good_super_pine <- in_super_pine [(in_super_pine$outlier_count > in_super_pine$p4),]
good_super_spruce_raw <- in_super_spruce_raw [(in_super_spruce_raw$outlier_count > in_super_spruce_raw$p4),]
good_super_pine_raw <- in_super_pine_raw [(in_super_pine_raw$outlier_count > in_super_pine_raw$p4),]

head(good_super_pine_raw)
head(good_super_spruce_raw)

results_pine$pine_super_raw<-(results_pine$tcontig %in% as.character(good_super_pine_raw$pine))
results_spruce$spruce_super_raw<-(results_spruce$tcontig %in% as.character(good_super_spruce_raw$spruce))

results_pine$pine_super<-(results_pine$tcontig %in% as.character(good_super_pine$pine))
results_spruce$spruce_super<-(results_spruce$tcontig %in% as.character(good_super_spruce$spruce))

sum(results_pine$pine_super_raw)
sum(results_pine$pine_super)
sum(results_spruce$spruce_super_raw)
sum(results_spruce$spruce_super)
...
save(results_spruce, file="../data/large_files/var_out_GATK3_spruce_ALL.summary.ALL.annots.sorted.GOOD.window_RESULTS_altGCTABAYENV_flipped_withSuper.Rdata")
```
...
results_spruce2 <- results_spruce
make_figure1 <- FALSE
make_figure2 <- FALSE
